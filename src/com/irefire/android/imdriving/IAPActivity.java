...
public class IAPActivity extends Activity {
    ...
    private static final Logger l = LoggerFactory.getLogger(IAPActivity.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";

        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
        if (!base64EncodedPublicKey.contains("AuKSfKz20BvZNBLRH2lOma9P7/2OpDJLH9")) {
            throw new RuntimeException("Illegal public key.");
        }
        if (!getPackageName().equals("com.irefire.android.imdriving")) {
            throw new RuntimeException("Please change the sample's package name! See README.");
        }

        // Create the helper, passing it our context and the public key to verify signatures with
        l.debug("Creating IAB helper.");
        ...
        l.debug("Starting setup.");
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                l.debug("Setup finished.");
                ...
                l.debug("Setup successful. Querying inventory.");
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            l.debug("Query inventory was successful.");
            ...
            l.debug("User is " + (mIsPremium ? "PREMIUM" : "NOT PREMIUM"));

            // Do we have the infinite gas plan?
            Purchase infiniteGasPurchase = inventory.getPurchase(SKU_INFINITE_GAS);
            mSubscribedToInfiniteGas = (infiniteGasPurchase != null &&
                    verifyDeveloperPayload(infiniteGasPurchase));
            l.debug("User " + (mSubscribedToInfiniteGas ? "HAS" : "DOES NOT HAVE")
            ...
            if (gasPurchase != null && verifyDeveloperPayload(gasPurchase)) {
                l.debug("We have gas. Consuming it.");
            ...
            updateUi();
            setWaitScreen(false);
            l.debug("Initial inventory query finished; enabling main UI.");
        }
    };

    // User clicked the "Buy Gas" button
    public void onBuyGasButtonClicked(View arg0) {
        l.debug("Buy gas button clicked.");
        ...
        setWaitScreen(true);
        l.debug("Launching purchase flow for gas.");
    ...
    public void onUpgradeAppButtonClicked(View arg0) {
        l.debug("Upgrade button clicked; launching purchase flow for upgrade.");
        setWaitScreen(true);
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        setWaitScreen(true);
        l.debug("Launching purchase flow for infinite gas subscription.");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        l.debug("onActivityResult(" + requestCode + "," + resultCode + "," + data);
        if (mHelper == null) return;
        ...
        if (!mHelper.handleActivityResult(requestCode, resultCode, data)) {
            ...
            l.debug("onActivityResult handled by IABUtil.");
        }
    }
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            l.debug("Purchase finished: " + result + ", purchase: " + purchase);
            ...
            if (purchase.getSku().equals(SKU_GAS)) {
                ...
                l.debug("Purchase is gas. Starting gas consumption.");
                mHelper.consumeAsync(purchase, mConsumeFinishedListener);
            }
            else if (purchase.getSku().equals(SKU_PREMIUM)) {
                // bought the premium upgrade!
                l.debug("Purchase is premium upgrade. Congratulating user.");
                ...
                l.debug("Infinite gas subscription purchased.");
    ...
    IabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new IabHelper.OnConsumeFinishedListener() {
        public void onConsumeFinished(Purchase purchase, IabResult result) {
            l.debug("Consumption finished. Purchase: " + purchase + ", result: " + result);
            ...
            if (result.isSuccess()) {
                ...
                l.debug("Consumption successful. Provisioning.");
            ...
            updateUi();
            setWaitScreen(false);
            l.debug("End consumption flow.");
        }
    };

    // Drive button clicked. Burn gas!
    public void onDriveButtonClicked(View arg0) {
        l.debug("Drive button clicked.");
        if (!mSubscribedToInfiniteGas && mTank <= 0) alert("Oh, no! You are out of gas! Try buying some!");
            ...
            updateUi();
            l.debug("Vrooom. Tank is now " + mTank);
        }
    }
    ...
    void complain(String message) {
        l.error("**** TrivialDrive Error: " + message);
        alert("Error: " + message);
    }
    ...
    void alert(String message) {
        ...
        l.debug("Showing alert dialog: " + message);
        bld.create().show();
    }
    ...
    void saveData() {
        ...
        spe.commit();
        l.debug("Saved data: tank = " + String.valueOf(mTank));
    }

    void loadData() {
        SharedPreferences sp = getPreferences(MODE_PRIVATE);
        mTank = sp.getInt("tank", 2);
        l.debug("Loaded data: tank = " + String.valueOf(mTank));
    }
}
